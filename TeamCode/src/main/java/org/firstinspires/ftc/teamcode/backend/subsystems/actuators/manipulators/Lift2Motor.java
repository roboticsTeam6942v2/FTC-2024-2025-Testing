...
public class Lift2Motor extends subsystem {
    ...
    public void setTargetPosition(int targetPosition) {
        motor1.setTargetPosition(targetPosition > this.max ? this.max : (Math.max(targetPosition, this.min)));
        motor2.setTargetPosition(targetPosition > this.max ? this.max : (Math.max(targetPosition, this.min)));
    }
